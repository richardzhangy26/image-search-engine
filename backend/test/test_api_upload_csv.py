...
"""
测试脚本：通过API上传CSV文件并导入商品数据
使用方法：
    python test_api_upload_csv.py <csv_file_path>
"""
...
def main():
    """主函数"""
    csv_file_path = "/Users/richardzhang/github/image-search-engine/商品/东莞市虎门熹因服饰商行(个体工商户).csv"
